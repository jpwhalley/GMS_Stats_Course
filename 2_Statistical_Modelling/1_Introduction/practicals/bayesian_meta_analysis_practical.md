...
This considers all models of association with one trait, with two traits, up to all traits.
And it uses Bayes Factors to compute relative strengths of evidence.
